  ...
  return (
      <div className="arcade-panel sudoku-panel" style={{ width: '100%', maxWidth: '100%', margin: '0 auto', padding: '0.5rem', boxSizing: 'border-box', overflow: 'hidden' }}>
        ...
        <div className="sudoku-layout" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center', width: '100%', maxWidth: '100%', overflow: 'hidden' }}>
          {/* GRIGLIA PRINCIPALE - Layout 100% fluido e responsive senza overflow */}
          <div className="sudoku-board-wrap" style={{ width: '100%', maxWidth: '410px', margin: '0 auto', overflow: 'hidden', boxSizing: 'border-box' }}>
            {/* Header colonne numerate */}
            <div style={{ display: 'grid', gridTemplateColumns: '18px repeat(9, 1fr)', gap: '1px', marginBottom: '2px', width: '100%', boxSizing: 'border-box' }}>
              <span></span>
              {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
                <span key={n} style={{ textAlign: 'center', color: '#00f0ff', fontSize: '9px', fontWeight: 'bold' }}>{n}</span>
              ))}
            </div>

            {/* Griglia con etichette righe */}
            <div style={{ display: 'grid', gridTemplateColumns: '18px 1fr', gap: '2px', width: '100%', boxSizing: 'border-box' }}>
              {/* Etichette righe A-I */}
              <div style={{ display: 'grid', gridTemplateRows: 'repeat(9, 1fr)', alignItems: 'center', color: '#00f0ff', fontSize: '9px', fontWeight: 'bold', textAlign: 'center' }}>
                  ...
                  return (
                      <button
                          ...
                          style={{
                            ...
                            borderBottom,
                            borderRight,
                            fontSize: 'clamp(0.65rem, 3.2vw, 1.1rem)',
          ...
          <div className="sudoku-sidepanel" style={{ width: '100%', maxWidth: '410px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '0.75rem', boxSizing: 'border-box' }}>
